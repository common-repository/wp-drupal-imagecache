...
?>
<h2><?php _e( 'Image crop settings', WPDI_Common::PLUGIN_SYSTEM_NAME ) ?></h2>
<p><?php _e( 'Cropping will remove portions of an image to make it the specified dimensions.', WPDI_Common::PLUGIN_SYSTEM_NAME ) ?></p>
<form method="post"
